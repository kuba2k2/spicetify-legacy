...
declare namespace Spicetify {
    ...
    namespace ContextMenu {
        ...
        class Item {
            ...
            constructor(name: string, onClick: (uris: string[]) => void, shouldAdd?: (uris: string[]) => boolean, icon?: Icon, disabled?: boolean)
        ...
        class SubMenu {
             ...
             */
            static readonly iconList: Icon[]
            constructor(name: string, subItems: Iterable<Item>, shouldAdd?: (uris: string[]) => boolean, icon?: Icon, disabled?: boolean)
            set name(text: string)
            set icon(name: Icon)
            set disabled(bool: boolean)
            /**
