...
/// <reference path="./spicetify-react-component.d.ts" />
/// <reference path="./spicetify-react-redux.d.ts" />
...
declare namespace Spicetify {
	...
	namespace ReactDOM {
		function findDOMNode(instance: ReactUMD.ReactInstance | null | undefined): Element | null | Text

		function unmountComponentAtNode(container: Element | DocumentFragment): boolean

		function createPortal(children: ReactUMD.ReactNode, container: Element, key?: null | string): ReactUMD.ReactPortal
